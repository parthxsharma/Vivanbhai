...
from AnonXMusic.utils.parth_ban import admin_filter
...
@app.on_message(filters.command(["annie", "Annie"], prefixes=["y", "Y"]) & admin_filter)
        ...
        for banned in data:
            ...
            if banned in ban:
                if user_id in SUDOERS:
                    ...
                    await message.reply("Another one bites the dust...! Banned {}"
