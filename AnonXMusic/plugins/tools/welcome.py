...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("AnonXMusic/assets/bg2.jpg")
    ...
    draw.text((30, 370), f'USER ID: {id}', fill=(255, 255, 255), font=font)
    draw.text((30, 40), f"CHAT NAME: {chatname}", fill=(225, 225, 225), font=welcome_font)
...
➖➖➖➖➖➖➖➖➖➖➖➖**
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/Annimusicbot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
